...
ActiveRecord::Schema.define(version: 2022_02_13_044001) do
  ...
  create_table "screens", primary_key: ["screen_num", "sheet_id"], charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
